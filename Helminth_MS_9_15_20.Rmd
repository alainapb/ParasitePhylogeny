...
important.names<-c("Macaca fuscata","Colobus angolensis","Ateles geoffroyi","Alouatta seniculus","Macaca cyclopis","Macaca fascicularis","Papio papio","Saguinus labiatus","Hylobates lar","Rhinopithecus bieti","Lemur catta","Prolemur simus","Piliocolobus tephrosceles","Chlorocebus aethiops","Piliocolobus rufomitratus",
                   #"Mirounga angustirostris",
                   #"Martes foina",
                   "Pan troglodytes","Gorilla beringei","Gorilla gorilla","Colobus angolensis","Pan paniscus","Pongo abelii", "Pongo pygmaeus","Saguinus mystax","Aotus nancymaae", "Cebus capucinus", "Saguinus midas", "Saimiri sciureus", "Saguinus fuscicollis", "Alouatta palliata")
...
MAM_FIG<-ggplot()+
  geom_point(summary_data, mapping=aes(x=global.mpd, y= distance, size = count))+
...
#species we want labeled in the figure
nearctic.important.names<-c("Didelphis virginiana", "Procyon lotor", "Ovibos moschatus", "Vulpes velox",
                            "Peromyscus gossypinus","Marmota monax", "Sciurus niger", 
                            "Didelphis marsupialis", "Urocyon cinereoargenteus", "Lontra canadensis",
                            "Peromyscus leucopus", "Blarina brevicauda", "Ursus americanus", 
                            "Oreamnos americanus", "Lynx rufus", "Peromyscus maniculatus", 
                            "Castor canadensis")
...
NEARCTIC_MAM<-ggplot()+
  ...
  geom_text_repel(nearctic_smaller_data, mapping=aes(x=nearctic.mpd, y=distance, label = name),
                  ...
                  vjust = .6,
                  point.padding = .2)+
  labs(y= " ", x = "Average MPD of a host's parasties")+
  scale_y_continuous(limits = c(0,400))+
  theme_bw()+
  theme(legend.position = "none")
