...
**Supplmental Figure 1.** 250 taxa helminth molecular phylogeny

```{r load_in_APBs_helminth_tree, fig.height=25, fig.width=7, units='in', res=300, echo=FALSE}
##load data
...
plotTree(gmpd_parasite_tree, fsize =0.8, lwd =3)
```
...
#load data
gmpd_bm_ouch <- readRDS("ouch_results/gmpd_bm_ouch")
gmpd_ou1_ouch <- readRDS("ouch_results/gmpd_ou1_ouch")
gmpd_oum_ouch <-readRDS("ouch_results/gmpd_oum_ouch")
nearctic_ou1_ouch <- readRDS("ouch_results/nearctic_ou1_ouch")
nearctic_bm_ouch <- readRDS("ouch_results/nearctic_bm_ouch")
nearctic_oum_ouch <-readRDS("ouch_results/nearctic_oum_ouch")
...
#read matrix
read.csv(file = "data/association_matrix_nearctic.csv", row.names = TRUE, col.names = TRUE)
...
read.csv(file = "data/gmpd_df.csv", row.names = TRUE, col.names = TRUE)
...
Mammal phylogeny colored by the parasite range of each host for the Nearctic dataset (mammals infected by a single helminth have a value of 0)
```{r mammal_tree_with_host_mpd, fig.height=7, fig.width=7, units='in', res=300, echo = FALSE}
#### NEARCTIC DATASET ####
#single parasite species have mpd = 0
contMap(nearctic_mammal_tree, nearctic_mam_mpd, fsize=0.5, lwd =1)
```


Mammal phylogeny colored by the parasite range of each host for the GMPD (mammals infected by a single helminth have a value of 0)
```{r , fig.height=15, fig.width=7, units='in', res=300, echo = FALSE}
#### GLOBAL DATASET ####
#single parasite species have mpd = 0
contMap(gmpd_mammal_tree, gmpd_mam_mpd, fsize=0.5, lwd =1.2)
```
